...
DOWNLOAD_BASE="${AP_DOWNLOAD_BASE:-https://ghfast.top/https://github.com/mkoyazilim/downloadaurapanel/releases/download/v${PANEL_VERSION}}"
PANEL_BASE="${AP_PANEL_BASE:-https://ghfast.top/https://github.com/chnzone/aurapanel/releases/download/v${PANEL_VERSION}}"
PANEL_PORT=8080
ACCESS_MODE="private"
SKIP_OLS=0
...
if [[ ! -d "$SNAPPY_DIR" ]]; then
  ...
  SNAPPY_VER="2.38.2"
  SNAPPY_URL="https://ghfast.top/https://github.com/the-djmaze/snappymail/releases/download/v${SNAPPY_VER}/snappymail-${SNAPPY_VER}.tar.gz"
  mkdir -p "$SNAPPY_DIR"
